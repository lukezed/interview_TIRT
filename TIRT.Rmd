...
ggplot(plot_df, aes(x = a_Estimate, y = r_Estimate, color = Domain)) +
...
ggplot(plot_df, aes(x = V1, y = V2, fill = Cor)) +
  ...
  theme(
    ...
    # Bürkner style: Gray banner with black frame
